...
inline void fft_core(double* input_real, double* input_imag, uint64_t size, uint64_t gap, double* output_real, double* output_imag, bool forwards)
{
    if(size == 1)
    {
...
inline void normalize_fft(double* input_real, double* input_imag, uint64_t size)
{
...
inline void half_normalize_fft(double* input_real, double* input_imag, uint64_t size)
{
    for(uint64_t i = 0; i < size; i++)
    {
...
inline void fft(double* input_real, double* input_imag, uint64_t size, double* output_real, double* output_imag)
{
...
inline void ifft(double* input_real, double* input_imag, uint64_t size, double* output_real, double* output_imag)
{
